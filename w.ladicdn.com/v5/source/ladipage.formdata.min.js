LadiPageScriptV2.prototype.parseFormCheckoutProduct = function(e) {
        var t = {};
        try {
            t = JSON.parse(Base64.decode(e.getAttribute("data-product")))
        } catch (n) {
            try {
                t = JSON.parse(e.getAttribute("data-product"))
            } catch (e) {
                console.error(e)
            }
        }
        return t
    }, LadiPageScriptV2.prototype.sendFormCheckout = function(e, t) {
        var n = this,
            a = (e = n.findAncestor(e, "ladi-element")).getAttribute("data-payment");
        a = JSON.parse(a);
        var i, o = e.querySelectorAll('[data-form-checkout-item="product"] div[data-product]'),
            r = [];
        if (1 === o.length) {
            var c = n.findAncestor(o[0], "ladi-form-checkout-box");
            (W = n.parseFormCheckoutProduct(c)).quantity = 1;
            var d = c.querySelector(".ladi-form-checkout-payment-quantity input");
            isEmptyLadiPage(d) || (W.quantity = parseInt(d.value) || W.quantity), r.push(W)
        } else r = Array.from(e.querySelectorAll('[data-form-checkout-item="product"] .ladi-form-checkout-product-check.checked')).map(function(e) {
            var t = n.findAncestor(e, "ladi-form-checkout-box"),
                a = n.parseFormCheckoutProduct(t);
            a.quantity = 1;
            var i = t.querySelector(".ladi-form-checkout-payment-quantity input");
            return isEmptyLadiPage(i) || (a.quantity = parseInt(i.value) || a.quantity), a
        });
        (i = Array.from(e.querySelectorAll('[data-form-checkout-item="bump_offer"] .ladi-form-checkout-bump-offer-check.multiple.checked')).map(e => {
            const t = e.closest(".ladi-form-checkout-bump-offer-product");
            return { ...isEmptyLadiPage(t) ? null : n.parseFormCheckoutProduct(t),
                quantity: 1
            }
        })).length > 0 && Array.prototype.push.apply(r, i);
        var s = isObjectLadiPage(n.runtime.payment_setting) ? n.runtime.payment_setting : {},
            u = t.setFormData(e, !1),
            l = u.formDataObject,
            p = (u = t.setFormDataObjectThankyou()).formDataObjectThankyou,
            m = u.formDataObjectConvertThankyou,
            _ = isEmptyLadiPage(l.name) ? "" : l.name,
            g = isEmptyLadiPage(l.email) ? "" : l.email,
            f = isEmptyLadiPage(l.phone) ? "" : l.phone,
            h = isEmptyLadiPage(l.message) ? "" : l.message,
            y = !isEmptyLadiPage(isEmptyLadiPage(l.i_agree_terms_and_conditions) ? "" : l.i_agree_terms_and_conditions),
            v = isEmptyLadiPage(l.country) ? "" : l.country.split(":")[0],
            E = isEmptyLadiPage(l.state) ? "" : l.state.split(":")[0],
            k = isEmptyLadiPage(l.ward) ? "" : l.ward.split(":")[0],
            L = isEmptyLadiPage(l.district) ? "" : l.district.split(":")[0],
            P = isEmptyLadiPage(l.address) ? "" : l.address.split(":")[0],
            b = !1,
            A = !1,
            w = !1,
            O = !0,
            x = 0,
            S = isObjectLadiPage(n.runtime.tmp.form_data_value_all) ? n.runtime.tmp.form_data_value_all : {},
            T = "true" === e.getAttribute("is_auto_funnel");
        if (t.checkValidate(e, !1, null)) {
            var N = function(a, i) {
                    var o = s.thankyou_type,
                        r = s.thankyou_value,
                        c = !1;
                    n.runtime.has_popupx && n.runtime.tmp.popupx_is_inline && (c = !0);
                    var d = 0,
                        u = n.runtime.eventData[e.id]["option.form_auto_funnel"],
                        l = "";
                    o == n.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(r) || n.showMessage(r, m)), o == n.const.FORM_THANKYOU_TYPE.popup && (u && n.setDataReplaceElement(!1, !1, m, r), window.ladi(r).show(!1, {
                        formThankyouPopupXInline: c
                    })), o != n.const.FORM_THANKYOU_TYPE.url && o != n.const.FORM_THANKYOU_TYPE.url_default || isEmptyLadiPage(a) || (r = window.ladi(a).encode_thankyou_url(), l = function(e, t, a) {
                        var i = Object.assign(n.copy(S), n.copy(p), a || {});
                        i = Object.assign(i, {
                            qr_code: n.runtime.tmp.current_qr_code_link
                        }), e = window.ladi(e).get_url(i, t, !1);
                        var o = new URL(e, window.location.origin);
                        return Object.keys(i).forEach(function(t) {
                            o.searchParams.has(t) || e.includes("{{" + t + "}}") || void 0 !== i[t] && null !== i[t] && "" !== i[t] && o.searchParams.append(t, i[t])
                        }), o.toString()
                    }(r, u, {
                        ls_data: i
                    }), d += 1e3, n.runTimeout(function() {
                        window.ladi(l).open_url()
                    }, d)), t.resetFormValue(e.querySelector(".ladi-form"))
                },
                C = function(e, t) {
                    "Success" == e && N(t.thanks_url, t.ls_data), "Canceled" == e && n.showMessage(n.const.LANG.FORM_CHECKOUT_ORDER_CANCEL)
                };
            window.formCheckoutDownloadQRCode = function() {
                const e = document.getElementById("form-checkout-bank-qr").src;
                fetch(e).then(e => e.blob()).then(e => {
                    const t = new FileReader;
                    t.onloadend = function() {
                        const e = t.result,
                            n = document.createElement("a");
                        n.href = e, n.download = "qr_code.png", document.body.appendChild(n), n.click(), document.body.removeChild(n)
                    }, t.readAsDataURL(e)
                }).catch(e => console.error("Error downloading image:", e))
            }, window.formCheckoutCopyToClipboard = function(e) {
                const t = e.closest(".info-row"),
                    n = t ? t.querySelector(".info-value") : null;
                if (n) {
                    const t = n.textContent.trim(),
                        a = document.createElement("input");
                    a.style.position = "absolute", a.style.left = "-9999px", document.body.appendChild(a), a.value = t, a.select(), document.execCommand("copy"), document.body.removeChild(a);
                    const i = e.querySelector(".tooltiptext.right"),
                        o = i.getAttribute("tooltiptext");
                    i.setAttribute("tooltiptext", "Copied to clipboard!"), i.style.visibility = "visible", i.style.opacity = "1", setTimeout(() => {
                        i.setAttribute("tooltiptext", o), i.style.visibility = "hidden", i.style.opacity = "0"
                    }, 2e3)
                } else console.error("The .info-value element was not found.")
            }, window.formCheckoutClosePopupQRCode = function() {
                b = !0;
                var e = document.querySelector(".ladipage-message");
                e && e.remove();
                var t = document.querySelector("body .ladi-wraper");
                t && (t.style.display = "block"), n.removeTimeout(x), x = null
            }, window.clickConfirmBankedCheckout = function() {
                console.log("clickConfirmBankedCheckout")
            };
            var q = function(e, t) {
                t && delete n.runtime.tmp.current_qr_code_link, b = !1;
                var a = "form-checkout-bank-qr",
                    i = e.bank_info.banks[0].autoConfirmPayment;
                const o = document.querySelector("body .ladi-wraper"),
                    r = window.innerWidth <= 768;
                if (o && r ? o.style.display = "none" : o && (o.style.display = ""), isEmptyLadiPage(document.getElementById(a))) {
                    ...
                    const t = document.querySelector(".count-down"),
                        a = document.getElementById("countdown-timer"),
                        i = document.getElementById("countdown-message"),
                        o = document.querySelector(".close-popup"),
                        r = document.querySelector(".sub-title");
                    let c = Date.now() + 60 * e * 1e3;
                    a.style.display = "block", i.style.display = "none", o.style.display = "block",
                        function e() {
                            const d = Math.max(0, c - Date.now()),
                                s = Math.floor(d / 6e4),
                                u = Math.floor(d % 6e4 / 1e3);
                            a.textContent = `${String(s).padStart(2,"0")} phút ${String(u).padStart(2,"0")} giây`, d > 0 ? x = n.runTimeout(e, 1e3) : (i.style.textAlign = "center", i.style.display = "block", i.style.color = "#E01A1A", i.style.maxWidth = "632px", o.style.display = "block", t.style.display = "none", r.style.display = "none", w = !0)
                        }()
                }(5), A = !0);
                var c = new XMLHttpRequest;
                c.open("POST", n.const.API_LADISALE_CHECKOUT_GET_ORDER_STATUS), c.addEventListener("readystatechange", function() {
                    if (4 === this.readyState) try {
                        var t = JSON.parse(this.responseText);
                        if (200 != t.code) throw new TypeError("api error");
                        if ("Pending" == t.data.payment_status || "OnHold" == t.data.payment_status) throw new TypeError("fetch api");
                        C(t.data.payment_status, e)
                    } catch (t) {
                        setTimeout(function() {
                            !b && q(e, !1)
                        }, 1e4)
                    }
                }), c.setRequestHeader("content-type", "application/json"), !O || b || w || (O = i, c.send(JSON.stringify({
                    ls_data: e.ls_data
                })))
            };
            isEmptyLadiPage(n.runtime.tmp.form_checkout_order_id) && (n.runtime.tmp.form_checkout_order_id = n.randomString(10)), n.showLoadingBlur();
            var R = localStorage.getItem("previousSubmission");
            ...
            var F, I, M, j = r.map(function(t) {
                return {
                    product_id: t.product_id,
                    product_variant_id: t.product_variant_id,
                    quantity: t.quantity,
                    product_type: t.product_type || "",
                    store_id: t.store_id_product,
                    up_sell_ids: (n = t.product_variant_id, a = e.id, i = [], document.querySelectorAll("#" + a + " .ladi-form-checkout-box").forEach(function(e) {
                        try {
                            var t = e.getAttribute("data-product");
                            if (JSON.parse(Base64.decode(t)).product_variant_id == n && e.querySelector(".ladi-form-checkout-product-check.checked")) {
                                var a = e.querySelector(".ladi-form-checkout-combo-product");
                                a && a.querySelectorAll("[data-item-variant-id]").forEach(function(e) {
                                    var t = e.getAttribute("data-item-variant-id");
                                    t && "" !== t.trim() && i.push(t)
                                })
                            }
                        } catch (e) {}
            ...
            try {
                var U = {
                        code: a.code || null,
                        method_name: a.method_name || null
                    },
                    Y = D.variants.length !== j.length;
                if (!Y)
                    for (var B = 0; B < j.length; B++) !D.variants[B] || D.variants[B].product_id === j[B].product_id && D.variants[B].product_variant_id === j[B].product_variant_id && D.variants[B].quantity === j[B].quantity || (Y = !0);
                var G = function(e) {
                    var t = {
                        type: null,
                        bank_code: null
                    };
                    for (var n in e) e.hasOwnProperty(n) && "object" == typeof e[n] && null !== e[n] && ("type" in e[n] && (t.type = e[n].type), "bank_code" in e[n] && (t.bank_code = e[n].bank_code));
                    return t
                }(a);
                U.type = G.type, U.bank_code = G.bank_code;
                var H = D.customer_name !== _ || D.customer_email !== g || D.customer_phone !== f,
                    J = D.data_payment.code !== U.code || D.data_payment.type !== U.type || D.data_payment.bank_code !== U.bank_code;
                Y && (H = !0);
                var K = H;
                !H && J && (K = !1);
                var $ = e.id;
                let X = n.runtime.tmp[$ + "_data_discount_coupon_selected"] || null,
                    Z = n.runtime.tmp[$ + "_data_discount_shipping_selected"] || null,
                    ee = n.runtime.tmp[$ + "_data_method_shipping_selected"] || null;
                var V = "";

                function z(e) {
                    var t = window.ladi(e).get_cookie();
                    return isEmptyLadiPage(t) ? "" : t
                }
                try {
                    V = document.getElementById($).getAttribute("data-fb-event-id")
                } catch (te) {}
                var W = JSON.stringify({
                        order_note: h,
                        accept_policy: y,
                        tracking_script: (F = [], I = "ladi_run_tracking_" + n.randomString(10), M = `window.${I} = function (data) {\n                    try {\n                        new Function(data.str)();\n                        console.log(data.str);\n                    } catch (e) {\n                        setTimeout(function () {\n                            window.${I}(data);\n                        }, 100);\n                    }\n                };`, F.push(M), isArrayLadiPage(n.runtime.tmp.form_checkout_tracking_script) && n.runtime.tmp.form_checkout_tracking_script.forEach(function(e) {
                            F.push(`window.${I}(${JSON.stringify({str:e})});`)
                        }), 1 == F.length && (F = []), F.join("")),
                        tracking_conversion_api: n.runtime.tmp.form_checkout_tracking_conversion_api || [],
                        thank_url: s.thankyou_type == n.const.FORM_THANKYOU_TYPE.url_default ? "" : s.thankyou_value,
                        is_auto_funnel: T,
                        source_from: "LP",
                        invoiceInfo: {
                            isEnable: !1
                        ...
                        discount_code: X ? X.discount_code : null,
                        path_type: "product",
                        cart_token: !K && window.ladi("CART_TOKEN_FORM_CHECKOUT").get_cookie(),
                        checkout_token: !K && window.ladi("CHECKOUT_TOKEN_FORM_CHECKOUT").get_cookie(),
                        ...
                        utm: {
                            ...
                            data_fbc: z("_fbc"),
                            event_id: V,
                            ref: window.ladi("ladi_ref").get_cookie()
                        },
                        custom_fields_checkout: Object.entries(l).filter(([e]) => !["name", "email", "phone", "message", "address", "state", "district", "ward", "country", "i_agree_terms_and_conditions"].includes(e)).map(function(e) {
                            return {
                                name: e[0],
                                value: e[1]
                            }
                        }),
                        customer_country_code: v,
                        customer_state_id: E,
                        customer_district_id: L,
                        customer_ward_id: k,
                        customer_address: P,
                        shipping_country_code: v,
                        shipping_state_id: E,
                        shipping_district_id: L,
                        shipping_ward_id: k,
                        shipping_address: P,
                        shipping_method_id: ee ? ee.shipping_method_id : null,
                        discount_shipping_code: Z ? Z.code : null
                    }),
                    Q = new XMLHttpRequest;
                Q.addEventListener("readystatechange", function() {
                    4 === this.readyState && (! function(e) {
                        try {
                            var t = JSON.parse(e);
                            if (200 != t.code || !isObjectLadiPage(t.data)) return n.showMessage(t.message);
                            if (window.ladi_fbq("track", "InitiateCheckout", {
                                    value: r.reduce(function(e, t) {
                                        return e + t.price * t.quantity
                                    }, 0),
                                    currency: n.runtime.currency,
                                    content_ids: r.map(function(e) {
                                        return e.product_variant_id
                                    }),
                                    num_items: r.reduce(function(e, t) {
                                        return e + t.quantity
                                    }, 0),
                                    products_name: r.map(function(e) {
                                        return e.name
                                    })
                                }), t.data, !isEmptyLadiPage(t.data.redirect_url) && isEmptyLadiPage(t.data.vnptEPayData) && (!isObjectLadiPage(t.data.bank_info) || isEmptyLadiPage(t.data.bank_info.base_64_qrCode))) return void n.runTimeout(function() {
                                window.location.href = t.data.redirect_url
                            }, 1e3);
                            if (isObjectLadiPage(t.data.bank_info) && !t.data.bank_info.qr_url && !isEmptyLadiPage(t.data.bank_info.base_64_qrCode)) return void q(t.data, !0);
                            ...
                            if (t.data.vnptEPayData) {
                                var a = document.createElement("div");
                                a.style.display = "none", a.appendChild(function(e = {}) {
                                    var t = document.createElement("form");
                                    return t.id = "megapayForm", t.name = "megapayForm", t.method = "POST", [{
                                        name: "invoiceNo",
                                        value: e.invoice_no
                                    }, {
                                        name: "amount",
                                ...
                                }(t.data.vnptEPayData)), document.body.appendChild(a), window.openPayment(1, t.data.vnptEPayData.domain)
                            }
                            N(t.data.thanks_url, t.data.ls_data)
                        } catch (e) {
                            return console.log(e), n.showMessage(n.const.LANG.REQUEST_SEND_ERROR)
                        }
                    }(this.responseText), n.hideLoadingBlur())
                }), Q.open("POST", n.const.API_LADISALE_CHECKOUT_PAYMENT), Q.setRequestHeader("Content-Type", "application/json"), Q.send(W), D = {
                    customer_name: _,
                    customer_email: g,
                    customer_phone: f,
                    variants: j,
                    data_payment: U
                }, localStorage.setItem("previousSubmission", JSON.stringify(D))
            } catch (ne) {
                n.hideLoadingBlur()
            }
        }
    }, LadiPageScriptV2.prototype.eventFormCheckoutSelectPaymentType = function(e) {
        var t = this;
        t instanceof LadiPageScriptV2 || (t = LadiPageScript), e.stopPropagation();
        var n = t.findAncestor(e.target, "ladi-form-checkout-box"),
            a = t.findAncestor(e.target, ["ladi-form", "ladi-element"]);
        isObjectLadiPage(LadiPageScript.runtime.tmp.isObjectCheck) || (LadiPageScript.runtime.tmp.isObjectCheck = {});
        var i = LadiPageScript.runtime.tmp.isObjectCheck[a.id];
        delete LadiPageScript.runtime.tmp.isObjectCheck[a.id];
        var o = !1,
            r = {};
        try {
            r = t && t.runtime && isObjectLadiPage(t.runtime.payment_setting) ? t.runtime.payment_setting : {}
        } catch (e) {
            console.error("Lỗi parse payment_setting:", e)
        }
        if (Array.isArray(r.list_payment) && (o = r.list_payment.some(e => "VNPT_EPAY" === e.payment_code)), console.log("debug hasVNPT_EPAY:", o), o) {
            var c = document.createElement("script");
            c.type = "text/javascript", c.rel = "preload", c.src = "https://pg.megapay.vn/pg_was/js/payment/layer/paymentClient.js", c.async = !0, document.head.appendChild(c)
        }
        if (!document.querySelector('script[src="https://code.jquery.com/jquery-1.11.1.min.js"]')) {
            var d = document.createElement("script");
            d.type = "text/javascript", d.rel = "preload", d.src = "https://code.jquery.com/jquery-1.11.1.min.js", d.async = !0, document.head.appendChild(d)
        }
        ...
        var s = function() {
                document.querySelector(".ladipage-message-close").click(), isEmptyLadiPage(a.getAttribute("data-payment")) && a.setAttribute("data-payment", JSON.stringify({}))
            },
            u = function(e) {
                var t = a.querySelector('.ladi-element[data-form-checkout-item="payment"] .ladi-form-checkout-box[data-payment-code="' + e.code + '"] .ladi-form-checkout-payment-content span:last-child');
                t.hasAttribute("data-old") || t.setAttribute("data-old", t.textContent), isEmptyLadiPage(e.code) ? t.textContent = t.getAttribute("data-old") : t.textContent = e.method_title || t.getAttribute("data-old"), isEmptyLadiPage(e.code) || (Array.from(a.querySelectorAll('[data-form-checkout-item="payment"] .ladi-form-checkout-payment-check.checked')).forEach(function(e) {
                    e.classList.remove("checked")
                }), Array.from(a.querySelectorAll('[data-form-checkout-item="payment"] [data-payment-code="' + e.code + '"] .ladi-form-checkout-payment-check')).forEach(function(e) {
                    e.classList.add("checked")
                })), a.setAttribute("data-payment", JSON.stringify(e)), s()
            },
            l = document.querySelector(".ladipage-message-text iframe"),
            p = function() {
                if (isEmptyLadiPage(l)) return;
                var e = isObjectLadiPage(t.runtime.payment_setting) ? t.runtime.payment_setting : {},
                    o = a.hasAttribute("data-payment") ? JSON.parse(a.getAttribute("data-payment")) : {};
                o.code = n.getAttribute("data-payment-code");
                var r = t.runtime.tmp.html_payment_str;
                const c = a.id,
                    d = document.querySelectorAll(`#${c} .ladi-form-checkout-product-check.multiple.checked`);
                var p = null;
                d.forEach(e => {
                    const n = e.closest(".ladi-form-checkout-box");
                    n && (p = t.parseFormCheckoutProduct(n))
                }), l.contentWindow.isFirstClickMethodPayment = i, l.contentWindow.payment_continue = u, l.contentWindow.payment_cancel = s, l.contentWindow.payment_setting = e, l.contentWindow.current_select = o, l.contentWindow.ladi_uid = t.runtime.store_ladiuid, l.contentWindow.end_point_api = t.const.API_LADISALE_LIST_GATEWAY, l.contentWindow.objDataProduct = p, l.contentDocument.open(), l.contentDocument.write(r), l.contentDocument.close()
            };
        isEmptyLadiPage(t.runtime.tmp.html_payment_str) ? fetch(t.const.URL_LADI_PAYMENT()).then(e => e.text()).then(e => {
            t.runtime.tmp.html_payment_str = e, p()
        }).catch(e => {}) : p()
    }, LadiPageScriptV2.prototype.checkValidateSendFormCheckout = function(e) {
        var t = this;
        try {
            if (0 == e.querySelectorAll('[data-form-checkout-item="product"] div[data-product]').length) throw new TypeError("no product")
        } catch (e) {
            return t.showMessage(t.const.LANG.FORM_VALIDATE_CHECKOUT_PRODUCT), !1
        }
        try {
            var n = JSON.parse(e.getAttribute("data-payment"));
            if (0 == Object.keys(n).length) throw new TypeError("no payment")
        } catch (n) {
            if (e.querySelectorAll('[data-form-checkout-item="payment"] div[data-payment-code]').length > 1) return t.showMessage(t.const.LANG.FORM_VALIDATE_CHECKOUT_PAYMENT);
            isObjectLadiPage(LadiPageScript.runtime.tmp.isObjectCheck) || (LadiPageScript.runtime.tmp.isObjectCheck = {}), delete LadiPageScript.runtime.tmp.isObjectCheck[e.id];
            var a = e.querySelector('[data-form-checkout-item="payment"] .ladi-form-checkout-payment-content');
            return a && a.click(), !1
        }
        return !0
        ...
        var e = this,
            ...
            n = function(t) {
                try {
                    var n = e.findAncestor(t, "ladi-form-checkout-box"),
                        a = e.parseFormCheckoutProduct(n);
                    if (isEmptyLadiPage(a.min)) throw new TypeError("no min");
                    return parseInt(a.min) || 1
                } catch (e) {
                    return 1
                }
            },
            a = function(t) {
                try {
                    var n = e.findAncestor(t, "ladi-form-checkout-box"),
                        a = e.parseFormCheckoutProduct(n);
                    if (isEmptyLadiPage(a.max)) throw new TypeError("no max");
                    return parseInt(a.max) || 1
                } catch (e) {
                    return 1e6
                }
            },
            i = function(e) {
                ...
                t < n(e.target) && (t = n(e.target)), t > a(e.target) && (t = a(e.target)), e.target.value = t, c(e)
            },
            o = function(e) {
                var t = e.target.parentElement.querySelector("input");
                t.value = (parseInt(t.value) || 0) + 1, t.value > a(e.target) && (t.value = a(e.target)), c(e)
            },
            r = function(e) {
                var t = e.target.parentElement.querySelector("input");
                t.value = (parseInt(t.value) || 0) - 1, t.value < n(e.target) && (t.value = n(e.target)), c(e)
            },
            c = function(n) {
                var a = e.findAncestor(n.target, ["ladi-form", "ladi-element"]).id;
                let i = document.querySelectorAll("#" + a + ' [data-form-checkout-item="product"] div[data-product]'),
                    o = document.querySelectorAll("#" + a + ' [data-form-checkout-item="bump_offer"] .ladi-form-checkout-bump-offer-check.checked'),
                    r = document.querySelectorAll("#" + a + " .ladi-form-checkout-product-check.checked, #" + a + ' [data-form-checkout-item="product"] [data-product] .ladi-form-checkout-payment-item > span.checked'),
                    c = document.querySelectorAll("#" + a + " .ladi-form-checkout-bump-offer-check.checked");
                const d = Array.from(r).concat(Array.from(c));
                if (1 == i.length && (r = document.querySelectorAll("#" + a + " .ladi-form-checkout-product-check, #" + a + ' [data-form-checkout-item="product"] [data-product] .ladi-form-checkout-payment-item > span')), 0 == r.length) {
                    var s = e.findAncestor(n.target, "ladi-form");
                    s.querySelectorAll('[data-form-checkout-item="bump_offer"]').length > 0 && (Array.from(s.querySelectorAll('[data-form-checkout-item="bump_offer"] .ladi-form-checkout-bump-offer-check.checked')).forEach(function(e) {
                        e.classList.remove("checked")
                    }), c = [])
                }
                let u = [];
                if (1 === i.length) {
                    const t = i[0].closest(".ladi-form-checkout-box"),
                        n = t.querySelector('.ladi-form-checkout-payment-quantity input[type="number"]');
                    if (t) {
                        const a = e.parseFormCheckoutProduct(t),
                            i = isEmptyLadiPage(n) ? 1 : parseInt(n.value);
                        u.push({
                    ...
                    o.forEach(t => {
                        const n = t.closest(".ladi-form-checkout-bump-offer-product"),
                            a = e.parseFormCheckoutProduct(n);
                        u.push({
                            product_variant_id: a.product_variant_id,
                            quantity: 1
                    ...
                    const n = t.closest(".ladi-form-checkout-box, .ladi-form-checkout-bump-offer-product"),
                        a = isEmptyLadiPage(n) ? null : n.querySelector('.ladi-form-checkout-payment-quantity input[type="number"]');
                    if (n) {
                        const t = e.parseFormCheckoutProduct(n),
                            i = isEmptyLadiPage(a) ? 1 : parseInt(a.value);
                        u.push({
                            product_variant_id: isObjectLadiPage(t) ? t.product_variant_id : null,
                            quantity: i
                        })
                    }
                });
                0 == r.length && 0 == c.length && (u = []);
                p(a, {
                    variants: u
                }), L(n, t)
            },
            d = function(n) {
                n.stopPropagation();
                var a = e.findAncestor(n.target, "ladi-element");
                if ("product" == a.getAttribute("data-form-checkout-item")) {
                    var i = e.findAncestor(n.target, "ladi-form-checkout-box"),
                        o = i.querySelector(".ladi-form-checkout-payment-check, .ladi-form-checkout-product-check");
                    if (o) {
                        var r = a.querySelectorAll(".ladi-form-item [data-product]");
                        if (o.classList.contains("checked") && 1 == r.length) return;
                        o.classList.contains("multiple") ? o.classList.toggle("checked") : (Array.from(i.parentElement.querySelectorAll(".ladi-form-checkout-payment-check.checked, .ladi-form-checkout-product-check.checked")).forEach(function(e) {
                            e.classList.remove("checked")
            ...
            s = function(t) {
                "payment" == e.findAncestor(t.target, "ladi-element").getAttribute("data-form-checkout-item") && e.eventFormCheckoutSelectPaymentType(t)
            },
            u = function(t) {
                if (t.stopPropagation(), "bump_offer" == e.findAncestor(t.target, "ladi-element").getAttribute("data-form-checkout-item")) {
                    var n = e.findAncestor(t.target, "ladi-form"),
                        a = n.querySelectorAll('[data-form-checkout-item="product"]');
                    let d = n.querySelectorAll('[data-form-checkout-item="product"] div[data-product]');
                    if (a.length > 0) {
                        var i, o, r = n.querySelectorAll('[data-form-checkout-item="product"] .ladi-form-checkout-product-check.checked, [data-form-checkout-item="product"] [data-product] .ladi-form-checkout-payment-item > span.checked');
                        if (1 == d.length)(o = (i = e.findAncestor(t.target, "ladi-form-checkout-bump-offer-checkbox")).querySelector(".ladi-form-checkout-bump-offer-check")) && (o.classList.contains("multiple") ? o.classList.toggle("checked") : (Array.from(i.parentElement.querySelectorAll(".ladi-form-checkout-bump-offer-check.checked")).forEach(function(e) {
                            e.classList.remove("checked")
                        }), o.classList.add("checked"))), c(t);
                        else if (r.length > 0)(o = (i = e.findAncestor(t.target, "ladi-form-checkout-bump-offer-checkbox")).querySelector(".ladi-form-checkout-bump-offer-check")) && (o.classList.contains("multiple") ? o.classList.toggle("checked") : (Array.from(i.parentElement.querySelectorAll(".ladi-form-checkout-bump-offer-check.checked")).forEach(function(e) {
                            e.classList.remove("checked")
                        }), o.classList.add("checked"))), c(t);
                        else LadiPageScript.showMessage(e.const.LANG.MESSAGE_WARNING_SELECT_PRODUCT_BUMP_OFFER)
                    }
                }
            },
            l = function(t, n, a, i, o, r, c, d = "") {
            ...
            p = function(t, n) {
                isObjectLadiPage(e.runtime.tmp.timeout_form_checkout_get_price) || (e.runtime.tmp.timeout_form_checkout_get_price = {}), e.removeTimeout(e.runtime.tmp.timeout_form_checkout_get_price), e.runtime.tmp.timeout_form_checkout_get_price[t] = e.runTimeout(function() {
                    try {
                        const o = document.querySelector("#" + t + ' [data-form-checkout-item="total_price"]');
                        if ("none" != window.getComputedStyle(o).display && n.variants.length > 0) {
                            var a = window.ladi("_cart_token").get_cookie(),
                                i = {
                                    "Content-Type": "application/json"
                                };
                            isEmptyLadiPage(a) || (i["cart-token"] = a), e.sendRequest("POST", e.const.API_LADISALE_PROMOTION, JSON.stringify(n), !0, i, function(n, a, i) {
                                if (i.readyState == XMLHttpRequest.DONE) try {
                                    var r = JSON.parse(n);
                                    if (200 == a && 200 == r.code && isObjectLadiPage(r.data) && isArrayLadiPage(r.data.variants)) {
                                        e.runtime.tmp[t + "_data_cart_promotions"] = r.data.variants;
                                        let n = e.runtime.tmp[t + "_data_discount_coupon_selected"];
                                        return n && isObjectLadiPage(n) ? void m(t, n.discount_code) : void g(t)
                                    }
                                    200 == a && 201 == a || e.showMessage(r.message)
                                } catch (r) {
                                    l(o.id, null, 0, 0, null, 0, 0)
                                }
                            })
                        } else l(o.id, null, 0, 0, null, 0, 0)
                    } catch (e) {
                        console.error(e)
                    }
                }, 500)
            ...
            m = function(n, a, i) {
                try {
                    ...
                    isEmptyLadiPage(c) || (d["cart-token"] = c);
                    let s = _(n) || [],
                        u = document.getElementById(n);
                    u && (u = u.querySelector("#value-coupon-code"));
                    u && u.textContent;
                    var o = "",
                        r = "";
                    const l = document.getElementById(n);
                    if (l) {
                        const e = l.querySelector('input[name="email"]'),
                            t = l.querySelector('input[name="phone"]');
                        e && (o = e.value), t && (r = t.value)
                    }
                    let p = {
                        domain: "",
                        path: "",
                        path_type: "product",
                        discount_code: a,
                        discount_shipping_code: i ? i.code : "",
                        shipping_state_id: t.state.split(":")[0],
                        shipping_district_id: t.district.split(":")[0],
                        shipping_method_id: i ? i.shipping_method_id : "",
                        variants: s,
                        customer_email: o,
                        customer_phone: r
                    };
                    e.sendRequest("POST", e.const.API_LADISALE_VALIDATE_COUPON_CODE, JSON.stringify(p), !0, d, function(t, a, i) {
                        if (i.readyState == XMLHttpRequest.DONE) try {
                            var o = JSON.parse(t);
                            if (200 == a) {
                                if (200 == o.code) {
                                    let t = document.getElementById(n),
                                        ...
                                        r = null,
                                        c = null;
                                    if (t && (a = t.querySelector(".checkout-block-discount-coupon"), i = t.querySelector("#value-coupon-code"), r = t.querySelector("#shipping-coupon"), c = t.querySelector("#value-coupon-shipping-code")), isObjectLadiPage(o.data)) {
                                        if (a && a.setAttribute("data-coupon-code", o.data.discount_code), a && isObjectLadiPage(o.data.discount_shipping) && a.setAttribute("data-coupon-shipping-code", o.data.discount_shipping.code), i) {
                                            i.textContent = "-" + e.formatCurrency(o.data.discount_price, e.runtime.currency, !0);
                                            let t = document.createElement("button");
                                            t.textContent = "✖", t.style.marginLeft = "8px", t.style.border = "none", t.style.background = "transparent", t.style.cursor = "pointer", t.style.color = "red", t.style.fontSize = "14px", t.addEventListener("click", function() {
                                                i.textContent = "Nhập mã giảm giá", i.removeAttribute("style"), a && a.removeAttribute("data-coupon-code"), e.runtime.tmp[n + "_data_discount_coupon_selected"] = null, g(n)
                                            }), i.appendChild(t)
                                        }
                                        i && 0 != o.data.discount_price ? (i.style.border = "1px solid #EF9300", i.style.borderRadius = "2px", i.style.color = "EF9300", i.style.padding = "2px 4px") : (i.textContent = "", i.style.border = "", i.style.borderRadius = "", i.style.padding = ""), c && r && isObjectLadiPage(o.data.discount_shipping) && 0 != o.data.discount_shipping.fee ? (c.textContent = "-" + e.formatCurrency(o.data.discount_shipping.fee, e.runtime.currency, !0), c.style.color = "#4AC000", r.style.display = "flex", r.style.alignItems = "center", r.style.gap = "4px", r.style.border = "1px solid #4AC000", r.style.borderRadius = "2px", r.style.padding = "2px 4px") : (r.style.display = "none", r.style.border = "", r.style.borderRadius = "", r.style.padding = "")
                                    }
                                    e.runtime.tmp[n + "_data_discount_coupon_selected"] = o.data, e.runtime.tmp[n + "_data_discount_shipping_selected"] = isObjectLadiPage(o.data.discount_shipping) && o.data.discount_shipping, g(n);
                                    let d = document.querySelectorAll(".ladipage-message-close");
                                    return void(d && (d.forEach(function(e) {
                                        e.click()
                                    }), document.body.style.overflow = ""))
                                }
                                e.showMessage(o.message)
                            }
                            200 == a && 201 == a || e.showMessage(o.message)
                        } catch (o) {}
                    })
                } catch (e) {
                    console.log("err validateCouponCode", e)
                }
            },
            _ = function(t) {
                let n = [],
                    a = document.querySelectorAll("#" + t + ' [data-form-checkout-item="product"] div[data-product]'),
                    i = document.querySelectorAll("#" + t + ' [data-form-checkout-item="bump_offer"] .ladi-form-checkout-bump-offer-check.checked'),
                    o = document.querySelectorAll("#" + t + " .ladi-form-checkout-product-check.checked, #" + t + ' [data-form-checkout-item="product"] [data-product] .ladi-form-checkout-payment-item > span.checked'),
                    r = document.querySelectorAll("#" + t + " .ladi-form-checkout-bump-offer-check.checked");
                const c = Array.from(o).concat(Array.from(r));
                if (1 === a.length) {
                    const t = a[0].closest(".ladi-form-checkout-box"),
                        o = t.querySelector('.ladi-form-checkout-payment-quantity input[type="number"]');
                    if (t) {
                        const a = e.parseFormCheckoutProduct(t),
                            i = isEmptyLadiPage(o) ? 1 : parseInt(o.value);
                        n.push({
                            product_name: a.name,
                            price: a.price,
                            product_variant_id: a.product_variant_id,
                            ...
                            quantity: i,
                            store_id_product: isObjectLadiPage(a) ? a.store_id_product : null
                        })
                    }
                    i.forEach(t => {
                        const a = t.closest(".ladi-form-checkout-bump-offer-product"),
                            i = e.parseFormCheckoutProduct(a);
                        n.push({
                            product_name: i.name,
                            price: i.price,
                    ...
                    const a = t.closest(".ladi-form-checkout-box, .ladi-form-checkout-bump-offer-product"),
                        i = isEmptyLadiPage(a) ? null : a.querySelector('.ladi-form-checkout-payment-quantity input[type="number"]');
                    if (a) {
                        const t = e.parseFormCheckoutProduct(a),
                            o = isEmptyLadiPage(i) ? 1 : parseInt(i.value);
                        n.push({
                            product_name: isObjectLadiPage(t) ? t.name : "",
                            price: isObjectLadiPage(t) ? t.price : "",
                            product_id: isObjectLadiPage(t) ? t.product_id : null,
                            product_variant_id: isObjectLadiPage(t) ? t.product_variant_id : null,
                            quantity: o,
                            store_id_product: isObjectLadiPage(t) ? t.store_id_product : null
                        })
                    }
                });
                return n
            ...
            g = function(t) {
                let n = e.runtime.tmp[t + "_data_discount_coupon_selected"] || null,
                    a = e.runtime.tmp[t + "_data_discount_shipping_selected"] || null,
                    i = e.runtime.tmp[t + "_data_cart_promotions"] || null,
                    o = 0,
                    r = 0,
                    c = 0,
                    d = 0,
                    ...
                    p = "";
                try {
                    const e = document.querySelector("#" + t + ' [data-form-checkout-item="total_price"]');
                    if (isEmptyLadiPage(e)) return;
                    let m = _(t) || [];
                    if ("none" != window.getComputedStyle(e).display && m.length > 0) {
                        if (m.forEach(e => {
                                o += e.price * e.quantity
                            }), n && n.discount_price ? (d = o - n.discount_price, c = n.discount_price) : d = o, i && i.length > 0) {
                            if (n && 0 == n.allow_promotion) r = 0;
                            else {
                                r = i.reduce((e, t) => {
                                    if (t.discount) {
                                        const {
                                        ...
                                        return 1 == n ? e + t.price * (a / 100) * t.quantity : e + a * t.quantity
                                    }
                                    return e
                                }, 0);
                                p = i.filter(e => e.discount && e.discount.note).map(e => e.discount.note).join(", "), d -= r, d < 0 && (d = 0)
                            }
                            d = o - r - c
                        }
                        const _ = document.querySelector("#" + t + ' [data-form-checkout-item="fee_shipping"]');
                        if (!isEmptyLadiPage(_)) {
                            const e = document.querySelector(".ladi-form-checkout-method-shipping-check.checked");
                            if (!isEmptyLadiPage(e)) {
                                const t = e.closest(".ladi-form-checkout-box").getAttribute("data-shipping-method");
                                if (!isEmptyLadiPage(t)) {
                                    const e = JSON.parse(Base64.decode(t));
                                    isEmptyLadiPage(e) || (s = e.value, d += e.value)
                                }
                            }
                        }
                        a && (u = a.fee, d -= a.fee), d < 0 && (d = 0), l(e.id, o, r, c, d, s, u, p)
                    }
                } catch (e) {
                    console.log("err.........", e)
                }
            ...
            f = function(t) {
                t.stopPropagation();
                var n = e.findAncestor(t.target, ["ladi-form", "ladi-element"]),
                    a = e.findAncestor(t.target, "ladi-element"),
                    i = n.id;
                if ("fee_shipping" == a.getAttribute("data-form-checkout-item")) {
                    var o = e.findAncestor(t.target, "ladi-form-checkout-box"),
                        r = o.querySelector(".ladi-form-checkout-payment-check, .ladi-form-checkout-method-shipping-check");
                    if (r) {
                        var c = a.querySelectorAll(".ladi-form-item [data-shipping-method]");
                        if (r.classList.contains("checked") && 1 == c.length) return;
                        r.classList.contains("multiple") ? r.classList.toggle("checked") : (Array.from(o.parentElement.querySelectorAll(".ladi-form-checkout-payment-check.checked, .ladi-form-checkout-method-shipping-check.checked")).forEach(function(e) {
                            e.classList.remove("checked")
                        }), r.classList.add("checked"))
                    }
                    const n = document.querySelector("#" + i + ' [data-form-checkout-item="fee_shipping"]');
                    if (!isEmptyLadiPage(n)) {
                        const t = document.querySelector("#" + i + " .ladi-form-checkout-method-shipping-check.checked");
                        if (!isEmptyLadiPage(t)) {
                            const n = t.closest(".ladi-form-checkout-box").getAttribute("data-shipping-method");
                            if (!isEmptyLadiPage(n)) {
                                const t = JSON.parse(Base64.decode(n));
                                isEmptyLadiPage(t) || (e.runtime.tmp[i + "_data_method_shipping_selected"] = t)
                            }
                        }
                    }
                    g(i)
            ...
            h = function(t) {
                ...
                isEmptyLadiPage(n) || (a["cart-token"] = n);
                let i = {
                    ladi_uid: e.runtime.store_ladiuid,
                    show_all: !0,
                    lang: "vi",
                    is_ladipage: !0
                };
                e.sendRequest("POST", e.const.API_LADISALE_LIST_GATEWAY, JSON.stringify(i), !0, a, function(e, n, a) {
                    if (a.readyState == XMLHttpRequest.DONE) try {
                        var i = JSON.parse(e);
                        if (200 == n)
                            if (200 != i.code || isEmptyLadiPage(i.data)) console.log("Response error: ", i.message);
                            else {
                                i.data.filter(e => 0 == e.status).map(e => e.code).forEach(e => {
                                    const t = document.querySelector(`[data-payment-code="${e}"]`);
                                    t && t.remove()
                                });
                                const e = document.querySelectorAll("#" + t + ' [data-form-checkout-item="payment"] .ladi-form-checkout-box');
                                if (1 == e.length) {
                                    e[0].style.borderBottom = "none";
                                    const t = e[0].querySelector(".ladi-form-checkout-payment-check");
                                    t && t.remove()
                                }
                                U()
                            }
                    } catch (i) {
                        console.log("err list gateway by ldp", i)
                    }
                })
            },
            y = !0,
            v = function(t = null) {
                ...
                if (n.classList.add("ladi-form-checkout-box"), t) {
                    const e = JSON.stringify({
                        shipping_method_name: t.name,
                        shipping_method_id: t.shipping_method_id,
                        value: t.fee
                    });
                    n.setAttribute("data-shipping-method", Base64.encode(e))
                }
                const a = document.createElement("div");
                a.classList.add("ladi-form-checkout-payment-item");
                const i = document.createElement("span");
                i.classList.add("ladi-form-checkout-payment-check", "ladi-form-checkout-method-shipping-check"), i.style.cursor = "pointer";
                const o = document.createElement("div");
                o.classList.add("ladi-form-checkout-payment-content", "ladi-form-checkout-shipping-content"), o.style.justifyContent = "space-between", o.style.flex = "1 1 0%", o.style.cursor = "pointer";
                const r = document.createElement("span");
                r.textContent = t ? t.name : "";
                const c = document.createElement("span");
                return c.textContent = t ? e.formatCurrency(t.fee, e.runtime.currency, !0) : "", o.appendChild(r), o.appendChild(c), a.appendChild(i), a.appendChild(o), n.appendChild(a), n.addEventListener("click", f), n
            },
            E = function(t) {
                const n = document.querySelector("#" + t + ' [data-form-checkout-item="fee_shipping"]');
                if (!isEmptyLadiPage(n)) {
                    const n = document.querySelector("#" + t + " .ladi-form-checkout-method-shipping-check.checked");
                    if (!isEmptyLadiPage(n)) {
                        const a = n.closest(".ladi-form-checkout-box").getAttribute("data-shipping-method");
                        if (!isEmptyLadiPage(a)) {
                            const n = JSON.parse(Base64.decode(a));
                            isEmptyLadiPage(n) || (e.runtime.tmp[t + "_data_method_shipping_selected"] = n)
                        }
                    }
                }
            },
            k = function(t) {
                const n = document.querySelector("#" + t + ' [data-form-checkout-item="fee_shipping"]');
                isEmptyLadiPage(n) || (n.style.height = "30px");
                const a = document.querySelector("#" + t + ' [data-form-checkout-item="fee_shipping"] .ladi-form-item');
                a && (a.innerHTML = "");
                const i = [];
                i.forEach(function() {
                    const e = v();
                ...
                var o = e.findAncestor(a, "ladi-element");
                o && (0 == i.length ? o.style.setProperty("display", "none", "important") : o.style.removeProperty("display")), g(t)
            },
            L = function(t, n) {
                var a = e.findAncestor(t.target, ["ladi-form", "ladi-element"]).id;
                let i = _(a) || [],
                    o = {
                        store_id: null != (i[0] && i[0].store_id_product) ? i[0].store_id_product : e.runtime.store_id_int,
                        state_id: n.state.split(":")[0],
                        district_id: n.district.split(":")[0],
                        discount_code: "",
                        lang: "vi",
                        variants: i
                    };
